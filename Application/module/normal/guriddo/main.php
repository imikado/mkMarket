...
class module_guriddo extends abstract_moduleembedded {
	...
	private $bScrollbarPagingEnable = 0;

	public function setPopupEdit($sPopupEdit) {
		$this->sPopupEdit = $sPopupEdit;
	}

	public function setPopupAdd($sPopupAdd) {
		$this->sPopupAdd = $sPopupAdd;
	}
	...
	public function enableScrollbarPaging() {
		$this->bScrollbarPagingEnable = 1;
	}
	...
	public function build() {
		...
		$oView->bScrollbarPagingEnable = $this->bScrollbarPagingEnable;
